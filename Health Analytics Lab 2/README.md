...
## Objectives
- Extract and explore actual and predicted outbreak labels.
- Evaluate model performance using a confusion matrix.
- Calculate Accuracy, Error Rate, Recall, and Precision.
- Visualize model performance metrics.
- Assess the model's usefulness when healthcare resources are limited.
- Interpret Machine Learning evaluation metrics in a healthcare and policy context.
